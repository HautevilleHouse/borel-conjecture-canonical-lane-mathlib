# Borel Conjecture — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/borel-conjecture-canonical-lane-mathlib.git
cd borel-conjecture-canonical-lane-mathlib
lake exe
lake build
```
